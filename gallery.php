...
<head>
    ...
    <meta name="title" content="Gallery | Malabe Boys' school Technology Society" />
    <meta name="og:title" content="Gallery | Malabe Boys' school Technology Society" />
    ...
    <title>Gallery | Malabe Boys' school Technology Society</title>
    <meta
        content="MBTS, ET, SFT, ICT,Malabe Boys' school, Malabe, Tech, Technology, Technology Society, Technology Section, Malabe Boys' school technology society"
        name="keywords">
...
<body>
    ...
    <main id="main">
        ...
        <!-- ======= Breadcrumbs ======= -->
        <section class="breadcrumbs dark-bg" style="background-color: #fff;">
            <div class="container">
        ...
        <section id="gallery" class="portfolio" style="background-color: #fff;">
	      <div class="container">
	        ...
	        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
	            <div class="portfolio-wrap">
	              <img src="https://i.ibb.co/d2RNXMV/Untitled-1.png" class="img-fluid" alt="">
	              <div class="portfolio-info">
	                <div class="portfolio-links">
	                  <a href="https://i.ibb.co/d2RNXMV/Untitled-1.png" data-gallery="portfolioGallery"
	          ...
	          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
	            <div class="portfolio-wrap">
	              <img src="https://i.ibb.co/tzNCQfk/Untitled-3.png" class="img-fluid" alt="">
	              <div class="portfolio-info">
	                <div class="portfolio-links">
	                  <a href="https://i.ibb.co/tzNCQfk/Untitled-3.png" data-gallery="portfolioGallery"
	                    class="portfolio-lightbox"><i class="bx bx-plus"></i></a>
	                </div>
	              </div>
	            </div>
	          ...
	          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
	            <div class="portfolio-wrap">
	              <img src="https://i.ibb.co/SKW709S/Untitled-5.png" class="img-fluid" alt="">
	              <div class="portfolio-info">
	                <div class="portfolio-links">
	                  <a href="https://i.ibb.co/SKW709S/Untitled-5.png" data-gallery="portfolioGallery"
	                    class="portfolio-lightbox"><i class="bx bx-plus"></i></a>
	                </div>
	              </div>
	            </div>
	        ...
	        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
	            <div class="portfolio-wrap">
	              <img src="https://i.ibb.co/TRjrGDy/Untitled-6.png" class="img-fluid" alt="">
	              <div class="portfolio-info">
	                <div class="portfolio-links">
	                  <a href="https://i.ibb.co/TRjrGDy/Untitled-6.png" data-gallery="portfolioGallery"
	                    class="portfolio-lightbox"><i class="bx bx-plus"></i></a>
	                </div>
	              </div>
	            </div>
	          ...
	          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
	            <div class="portfolio-wrap">
	              <img src="https://i.ibb.co/kgk3DpS/Untitled-7.png" class="img-fluid" alt="">
	              <div class="portfolio-info">
	                <div class="portfolio-links">
	                  <a href="https://i.ibb.co/kgk3DpS/Untitled-7.png" data-gallery="portfolioGallery"
	                    class="portfolio-lightbox"><i class="bx bx-plus"></i></a>
	                </div>
	              </div>
	            </div>
	          ...
	          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
	            <div class="portfolio-wrap">
	              <img src="https://i.ibb.co/wrrh3gm/Untitled-8.png" class="img-fluid" alt="">
	              <div class="portfolio-info">
	                <div class="portfolio-links">
	                  <a href="https://i.ibb.co/wrrh3gm/Untitled-8.png" data-gallery="portfolioGallery"
	                    class="portfolio-lightbox"><i class="bx bx-plus"></i></a>
	                </div>
	              </div>
	            </div>
	          ...
	          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
	            <div class="portfolio-wrap">
	              <img src="https://i.ibb.co/VVJnMw5/Untitled-9.png" class="img-fluid" alt="">
	              <div class="portfolio-info">
	                <div class="portfolio-links">
	                  <a href="https://i.ibb.co/VVJnMw5/Untitled-9.png" data-gallery="portfolioGallery"
	                    class="portfolio-lightbox"><i class="bx bx-plus"></i></a>
	                </div>
	              </div>
	            </div>
	          ...
	          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
	            <div class="portfolio-wrap">
	              <img src="https://i.ibb.co/Sw0M3YY/Untitled-10.png" class="img-fluid" alt="">
	              <div class="portfolio-info">
	                <div class="portfolio-links">
	                  <a href="https://i.ibb.co/Sw0M3YY/Untitled-10.png" data-gallery="portfolioGallery"
	                    class="portfolio-lightbox"><i class="bx bx-plus"></i></a>
	                </div>
	              </div>
	            </div>
	          ...
	          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
	            <div class="portfolio-wrap">
	              <img src="https://i.ibb.co/9gCL0qP/Untitled-11.png" class="img-fluid" alt="">
	              <div class="portfolio-info">
	                <div class="portfolio-links">
	                  <a href="https://i.ibb.co/9gCL0qP/Untitled-11.png" data-gallery="portfolioGallery"
	                    class="portfolio-lightbox"><i class="bx bx-plus"></i></a>
	                </div>
	              </div>
	            </div>
	          ...
	          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
	            <div class="portfolio-wrap">
	              <img src="https://i.ibb.co/J3y1Xf3/Untitled-12.png" class="img-fluid" alt="">
	              <div class="portfolio-info">
	                <div class="portfolio-links">
	                  <a href="https://i.ibb.co/J3y1Xf3/Untitled-12.png" data-gallery="portfolioGallery"
	                    class="portfolio-lightbox"><i class="bx bx-plus"></i></a>
	                </div>
	              </div>
	            </div>
	          ...
	          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
	            <div class="portfolio-wrap">
	              <img src="https://i.ibb.co/fv0gw3L/Untitled-13.png" class="img-fluid" alt="">
	              <div class="portfolio-info">
	                <div class="portfolio-links">
	                  <a href="https://i.ibb.co/fv0gw3L/Untitled-13.png" data-gallery="portfolioGallery"
	                    class="portfolio-lightbox"><i class="bx bx-plus"></i></a>
	                </div>
	              </div>
	            </div>
